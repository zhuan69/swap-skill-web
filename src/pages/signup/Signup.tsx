...
const Register = () => {
 ...
 return (
  <>
   <div
    style={{
     backgroundImage: "url('/sharing.jpg')",
     filter: "brightness(0.5)",
    }}
    className="absolute inset-0 w-auto min-h-[1300px]"></div>
    ...
    <div className="h-auto w-[70%] mx-auto flex flex-col items-center justify-center gap-10 text-[#5A5A5D]">
     <div className="flex items-center justify-center mt-[100px] h-[1100px] shadow-2xl rounded-xl w-[70%] bg-white">
      <form className="flex flex-col gap-3 w-[80%]">
       <h2 className="text-3xl font-medium text-black text-center">Register</h2>
       {/* email */}
       <div className="grid grid-cols-2 gap-2">
        ...
        <div className="flex flex-col">
         ...
         <LocalizationProvider dateAdapter={AdapterDayjs}>
          <DatePicker className="border-2 p-[15px] rounded-md w-full hover:border-black/[.6] focus:border-black/[.6] focus:outline-none" />
